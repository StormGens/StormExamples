...
public class ControlPanelLayout extends RelativeLayout {
    ...
    public ControlPanelLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (isLandscape) {
            ...
            heightSpec = MeasureSpec.makeMeasureSpec(measuredSize/2, MeasureSpec.EXACTLY);
        }
        		
        super.onMeasure(widthSpec, heightSpec);
        Log.v(TAG, "heightSpec:"+measuredSize);
    }
}
